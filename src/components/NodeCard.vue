        ...
        <div v-else class="grid grid-cols-2 gap-1.5">
          ...
          >
            <div class="flex items-center justify-between gap-1 text-[11px] leading-none">
              <span class="min-w-0 truncate text-muted-foreground" :title="latencyPanelLabel">{{ latencyPanelLabel }}</span>
              <span class="shrink-0 font-medium">{{ latencyDisplay }}</span>
            </div>
            <div
          ...
          >
            <div class="flex items-center justify-between gap-1 text-[11px] leading-none">
              <span class="min-w-0 truncate text-muted-foreground" :title="lossPanelLabel">{{ lossPanelLabel }}</span>
              <span class="shrink-0 font-medium">{{ lossDisplay }}</span>
            </div>
            <div
              class="grid h-full items-end gap-[1px] opacity-80 group-hover/panel:opacity-100"
